...
public class Nic {
	...
	public Nic(NicRequest req) {
		this.equipment = new Equipment(req.equipmentId());
		this.manufacture = new Manufacture(req.manufactureId());
		this.connectionType = new NetworkConnectionType(req.connectionTypeId());
		this.connectorType = new NetworkConnectorType(req.connectorTypeId());
		this.model = req.model();
		this.speed = req.speed();
		this.speedUnit = new Unit(req.speedUnitId());
	}
	
	public Nic(Long id, NicRequest req) {
		this(req);
		this.id = id;
	}
