...
public class UserController {
	...
	/* 
	 * TODO: User JWT Authentication
	 * Add JWT Authentication
	 * Including Generate New Token
	 * Refresh Token
	 * Validate Token
	 * Remove Token
	 */
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<UserContract>> add(@RequestBody UserRequest req){
		try {
	...
	@PutMapping("/edit/{id}")
	public ResponseEntity<BaseResponse<UserContract>> edit(@PathVariable Long id, @RequestBody UserRequest req){
		try {
