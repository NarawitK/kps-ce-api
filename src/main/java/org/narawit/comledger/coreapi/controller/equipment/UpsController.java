...
public class UpsController {
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<UpsContract>> add(@RequestBody UpsRequest req){
		try {
	...
	@PutMapping("/edit/{id}")
	public ResponseEntity<BaseResponse<UpsContract>> edit(@PathVariable Long id, @RequestBody UpsRequest req){
		try {
