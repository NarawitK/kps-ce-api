...
public class VgaController {
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<VgaContract>> add(@RequestBody VgaRequest req){
		try {
	...
	@PutMapping("/edit/[id}")
	public ResponseEntity<BaseResponse<VgaContract>> edit(@PathVariable Long id, @RequestBody VgaRequest req){
		try {
