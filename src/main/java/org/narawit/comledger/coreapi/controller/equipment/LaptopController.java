...
public class LaptopController {
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<LaptopContract>> add(@Valid @RequestBody LaptopRequest req){
		try {
			return ControllerHelper.getResponseEntity(EDITED_ENTRY_SUCCESSFULLY, svc.add(req), HttpStatus.CREATED, true);
	...
	@PutMapping("/edit/{id}")
	public ResponseEntity<BaseResponse<LaptopContract>> edit(@PathVariable Long id, @Valid @RequestBody LaptopRequest req){
		try {
