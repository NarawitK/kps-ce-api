...
public class PcController {
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<PcContract>> add(@Valid @RequestBody PcRequest req){
		try {
	...
	@PutMapping("/edit/{id}")
	public ResponseEntity<BaseResponse<PcContract>> edit(@PathVariable Long id, @Valid @RequestBody PcRequest req){
		try {
