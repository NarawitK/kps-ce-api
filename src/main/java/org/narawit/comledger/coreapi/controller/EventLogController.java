...
public class EventLogController {
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<EventLogContract>> add(@RequestBody EventLogRequest req){
		try {
	...
	@PutMapping("/edit/{id}")
	public ResponseEntity<BaseResponse<EventLogContract>> edit(@PathVariable Long id, @RequestBody EventLogRequest req){
		try {
