...
public class NetworkConnectorTypeController {
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<NetworkConnectorTypeContract>> add(@RequestBody NetworkConnectorTypeRequest req){
		try {
	...
	@PutMapping("/edit/{id}")
	public ResponseEntity<BaseResponse<NetworkConnectorTypeContract>> edit(@PathVariable Integer id, @RequestBody NetworkConnectorTypeRequest req){
		try {
