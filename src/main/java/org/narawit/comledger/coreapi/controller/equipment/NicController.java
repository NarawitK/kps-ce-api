...
public class NicController {
	...
	@PostMapping("/add")
	public ResponseEntity<BaseResponse<NicContract>> add(@RequestBody NicRequest req){
		try {
	...
	@PutMapping("/edit/[id}")
	public ResponseEntity<BaseResponse<NicContract>> edit(@PathVariable Long id, @RequestBody NicRequest req){
		try {
